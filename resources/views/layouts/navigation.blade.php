<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @endcan
                    @can('advances.view')
                        <x-nav-link :href="route('advances.index')" :active="request()->routeIs('advances.index')">
                            {{ __('Advances') }}
                        </x-nav-link>
                    @endcan
                    @can('salaries.view')
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endcan
            @can('advances.view')
                <x-responsive-nav-link :href="route('advances.index')" :active="request()->routeIs('advances.index')">
                    {{ __('Advances') }}
                </x-responsive-nav-link>
            @endcan
            @can('salaries.view')
